...
export const DAILY_CHALLENGES: DailyChallenge[] = [
  ...
  { id: 3,  theme: 'Politique', title: 'La démocratie directe est-elle viable ?', prompt: "La démocratie directe est supérieure à la démocratie représentative dans le monde moderne.", difficulty: 'moyen', persona: 'opponent' },
  ...
  { id: 9,  theme: 'Justice', title: "La prison est-elle efficace ?", prompt: "Le système carcéral actuel est un échec : il crée plus de criminalité qu'il n'en résout.", difficulty: 'moyen', persona: 'architect' },
  ...
  { id: 26, theme: 'Langage', title: "Le langage détermine-t-il la pensée ?", prompt: "La langue que nous parlons détermine fondamentalement notre façon de penser.", difficulty: 'difficile', persona: 'architect' },
