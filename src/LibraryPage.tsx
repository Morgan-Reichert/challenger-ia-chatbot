...
export default function LibraryPage({ onBack, onStartDebate, onStartInterview, userProfile }: Props) {
  ...
  return (
    <div className="flex-1 flex flex-col min-w-0 h-full bg-[var(--bg-app)] overflow-hidden">
      ...
      {/* ── Category tabs ── */}
      <div className="flex-shrink-0 bg-[var(--bg-chat)] border-b-2 border-[#5D7BFF]/10 px-6">
            ...
            <button
              ...
              className={cx(
                ...
                activeTab === id
                  ...
                  : 'border-transparent text-[var(--text-primary)]/30 hover:text-[#5D7BFF]/60'
              )}
            >
          ...
          <>
            <div className="mb-6">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h2 className="text-[15px] font-black uppercase tracking-widest text-[var(--text-primary)]">Débat</h2>
              </div>
            ...
            <div className="mb-6 space-y-3 max-w-5xl">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-[var(--bg-chat)] border-2 border-[var(--text-primary)]/8 focus:border-[#5D7BFF] pl-10 pr-4 py-2.5 text-[12px] font-medium text-[var(--text-primary)] placeholder:text-[var(--text-primary)]/25 focus:outline-none transition-colors"
                />
                {searchQuery && (
                  <button
                  ...
                  <button
                    ...
                    className={cx(
                      ...
                      filterCategory === cat
                        ...
                        : 'bg-[var(--bg-chat)] border-[var(--text-primary)]/10 text-[var(--text-primary)]/40 hover:border-[#5D7BFF]/40 hover:text-[#5D7BFF]'
                    )}
                  >
                    {cat}
                  </button>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 max-w-5xl">
              {visiblePersonas.map((persona, i) => (
                <motion.button
                  ...
                  className="text-left bg-[var(--bg-chat)] border-2 border-[var(--text-primary)]/8 hover:border-[#5D7BFF]/40 transition-all group overflow-hidden"
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div>
                        ...
                        <h3 className="text-[14px] font-black text-[var(--text-primary)] leading-tight">{persona.name}</h3>
                        <p className="text-[10px] text-[var(--text-primary)]/40 font-medium mt-0.5">{persona.title}</p>
                      </div>
                      <span className="text-2xl flex-shrink-0 mt-0.5">{persona.flag}</span>
                    </div>
                    <p className="text-[11px] text-[var(--text-primary)]/55 leading-relaxed mb-4 line-clamp-3">{persona.description}</p>
                    <div className="space-y-1 mb-4">
                      {persona.keyFacts.slice(0, 3).map((fact) => (
                        <div key={fact} className="flex items-start gap-1.5">
                          ...
                          <p className="text-[10px] text-[var(--text-primary)]/45">{fact}</p>
                        </div>
                      ))}
                    </div>
                    <div className="flex items-center gap-3 text-[9px] text-[var(--text-primary)]/30 font-bold uppercase tracking-wider border-t border-[var(--text-primary)]/6 pt-3">
              ...
              {!searchQuery && filterCategory === 'Tous' && (
                <motion.button
                  ...
                  className="text-left bg-[var(--bg-chat)] border-2 border-dashed border-[#7C3AED]/30 hover:border-[#7C3AED]/70 hover:bg-[#7C3AED]/[0.02] transition-all group overflow-hidden"
                  ...
                  <div className="p-5 flex flex-col h-full min-h-[260px]">
                    <div className="flex items-start justify-between gap-2 mb-3">
                      <div>
                        ...
                        <h3 className="text-[14px] font-black text-[var(--text-primary)] leading-tight">Créer un opposant</h3>
                        <p className="text-[10px] text-[var(--text-primary)]/40 font-medium mt-0.5">Personnage sur mesure</p>
                      </div>
                    ...
                    <p className="text-[11px] text-[var(--text-primary)]/55 leading-relaxed mb-4 flex-1">
        ...
        {selectedPersona && (
          ...
          >
            <motion.div
              ...
              className="bg-[var(--bg-chat)] w-full max-w-xl max-h-[85vh] overflow-y-auto"
            ...
            >
              ...
              <div className="px-7 py-6 border-b-2 border-[var(--text-primary)]/6 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="text-[22px] font-black text-[var(--text-primary)] leading-tight">{selectedPersona.name}</h2>
                  <p className="text-[11px] text-[var(--text-primary)]/40 font-medium mt-1">{selectedPersona.title}</p>
                </div>
                <button onClick={() => setSelectedPersona(null)} className="text-[var(--text-primary)]/20 hover:text-[var(--text-primary)]/60 transition-colors flex-shrink-0 mt-1">
                  <X className="w-5 h-5" />
                </button>
              </div>
              <div className="px-7 py-5 space-y-5">
                <p className="text-[12px] text-[var(--text-primary)]/60 leading-relaxed">{selectedPersona.description}</p>
                <div className="grid grid-cols-2 gap-3">
                  {[
                    ...
                    <div key={label} className="bg-[var(--bg-app)] p-3">
                      <p className="text-[8px] font-black uppercase tracking-widest text-[var(--text-primary)]/30 mb-0.5">{label}</p>
                      <p className="text-[11px] font-bold text-[var(--text-primary)]/70">{value}</p>
                    </div>
                  ))}
                </div>
                <div>
                  <p className="text-[9px] font-black uppercase tracking-widest text-[var(--text-primary)]/30 mb-3">Faits marquants</p>
                  <div className="space-y-2">
                    {selectedPersona.keyFacts.map((fact) => (
                      <div key={fact} className="flex items-start gap-2.5">
                        ...
                        <p className="text-[11px] text-[var(--text-primary)]/60">{fact}</p>
                      </div>
                    ))}
                  </div>
                </div>
        ...
        {customModalOpen && (
          ...
          >
            <motion.div
              ...
              animate={{ opacity: 1, scale: 1, y: 0 }}
              exit={{ opacity: 0, scale: 0.95, y: 20 }}
              className="bg-[var(--bg-chat)] w-full max-w-lg"
            ...
            >
              ...
              <div className="px-7 py-6 border-b-2 border-[var(--text-primary)]/6 flex items-start justify-between gap-4">
                <div>
                  ...
                  <h2 className="text-[20px] font-black text-[var(--text-primary)] leading-tight">Créer un adversaire</h2>
                  <p className="text-[11px] text-[var(--text-primary)]/40 font-medium mt-1">Décris le personnage que tu veux affronter</p>
                </div>
                <button onClick={handleCustomClose} className="text-[var(--text-primary)]/20 hover:text-[var(--text-primary)]/60 transition-colors flex-shrink-0 mt-1">
                  <X className="w-5 h-5" />
                </button>
              </div>
              <div className="px-7 py-5 space-y-4">
                <div>
                  <label className="block text-[9px] font-black uppercase tracking-widest text-[var(--text-primary)]/40 mb-2">Nom du personnage *</label>
                  <input
                    type="text"
                    value={customName}
                    ...
                    className="w-full border-2 border-[var(--text-primary)]/10 focus:border-[#7C3AED] bg-[var(--bg-chat)] px-4 py-3 text-sm font-medium text-[var(--text-primary)] placeholder:text-[var(--text-primary)]/25 focus:outline-none transition-colors"
                    maxLength={CUSTOM_PERSONA_MAX_NAME}
                  />
                  <p className="text-[9px] text-[var(--text-primary)]/25 mt-1 text-right">{customName.length}/{CUSTOM_PERSONA_MAX_NAME}</p>
                </div>
                <div>
                  <label className="block text-[9px] font-black uppercase tracking-widest text-[var(--text-primary)]/40 mb-2">Description / Profil <span className="normal-case font-normal">(optionnel)</span></label>
                  <textarea
                    value={customDesc}
                    ...
                    rows={5}
                    className="w-full border-2 border-[var(--text-primary)]/10 focus:border-[#7C3AED] bg-[var(--bg-chat)] px-4 py-3 text-sm font-medium text-[var(--text-primary)] placeholder:text-[var(--text-primary)]/25 focus:outline-none transition-colors resize-none leading-relaxed"
                    maxLength={CUSTOM_PERSONA_MAX_DESC}
                  />
                  <p className="text-[9px] text-[var(--text-primary)]/25 mt-1 text-right">{customDesc.length}/{CUSTOM_PERSONA_MAX_DESC}</p>
                </div>
                <div className="flex items-start gap-2 px-3 py-2.5 bg-amber-500/10 border border-amber-500/25">
                ...
                {customError && (
                  <motion.div initial={{ opacity: 0, y: -4 }} animate={{ opacity: 1, y: 0 }} className="flex items-center gap-2 px-3 py-2.5 bg-red-500/10 border border-red-500/25">
